...
public class TestExtremeRandomGenerator {

	private RandomGenerator extreme;

	@Before
	public void initialize() {
		extreme = RandomGeneratorFactory.getRandomGenerator(TestType.EXTREME_VALUES);
	}

	@Test
	public void testString() {
		for (int i = 0; i < 10000; i++) {
			String str = extreme.getString(10, 100);
	...
	public void testInt() {
		for (int i = 0; i < 10000; i++) {
			long lg = extreme.getLong(100, 1000);
	...
	public void testInt2() {
		for (int i = 0; i < 10000; i++) {
			long lg = extreme.getLong(-1000, -100);
	...
	public void testInt3() {
		for (int i = 0; i < 10000; i++) {
			long lg = extreme.getLong(-100, 100);
	...
	public void testDouble() {
		for (int i = 0; i < 10000; i++) {
			double dl = extreme.getDouble(100, 1000);
	...
	public void testDouble2() {
		for (int i = 0; i < 10000; i++) {
			double dl = extreme.getDouble(-1000, -100);
	...
	public void testDouble3() {
		for (int i = 0; i < 10000; i++) {
			double dl = extreme.getDouble(-100, 100);
	...
	public void testDateTime() {
		...
		for (int i = 0; i < 10000; i++) {
			String date = extreme.getDateTime();
			assertTrue(datePattern.matcher(date).find());
		}
	}
	...
	public void testValue() {
		...
		for (int i = 0; i < 10000; i++) {
			assertTrue(list.contains(extreme.getValue(list)));
		}
	}
