...
public class TestScalingRandomGenerator {

	private RandomGenerator scaling;

	@Before
	public void initialize() {
		scaling = RandomGeneratorFactory.getRandomGenerator(TestType.SCALLING);
	}

	@Test
	public void testString() {
		for (int i = 0; i < 10000; i++) {
			String str = scaling.getString(10, 100);
	...
	public void testInt() {
		for (int i = 0; i < 10000; i++) {
			long lg = scaling.getLong(100, 1000);
	...
	public void testInt2() {
		for (int i = 0; i < 10000; i++) {
			long lg = scaling.getLong(-1000, -100);
	...
	public void testInt3() {
		for (int i = 0; i < 10000; i++) {
			long lg = scaling.getLong(-100, 100);
	...
	public void testDouble() {
		for (int i = 0; i < 10000; i++) {
			double dl = scaling.getDouble(100, 1000);
	...
	public void testDouble2() {
		for (int i = 0; i < 10000; i++) {
			double dl = scaling.getDouble(-1000, -100);
	...
	public void testDouble3() {
		for (int i = 0; i < 10000; i++) {
			double dl = scaling.getDouble(-100, 100);
	...
	public void testDateTime() {
		...
		for (int i = 0; i < 10000; i++) {
			String date = scaling.getDateTime();
			assertTrue(datePattern.matcher(date).find());
		}
	}
	...
	public void testValue() {
		...
		for (int i = 0; i < 10000; i++) {
			assertTrue(list.contains(scaling.getValue(list)));
		}
	}
