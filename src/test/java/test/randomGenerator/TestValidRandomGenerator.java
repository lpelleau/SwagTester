...
public class TestValidRandomGenerator {

	private RandomGenerator valid;

	@Before
	public void initialize() {
		valid = RandomGeneratorFactory.getRandomGenerator(TestType.VALID);
	}

	@Test
	public void testString() {
		for (int i = 0; i < 10000; i++) {
			String str = valid.getString(10, 100);
	...
	public void testInt() {
		for (int i = 0; i < 10000; i++) {
			long lg = valid.getLong(100, 1000);
	...
	public void testInt2() {
		for (int i = 0; i < 10000; i++) {
			long lg = valid.getLong(-1000, -100);
	...
	public void testDouble() {
		for (int i = 0; i < 10000; i++) {
			double dl = valid.getDouble(100, 1000);
	...
	public void testDouble2() {
		for (int i = 0; i < 10000; i++) {
			double dl = valid.getDouble(-1000, -100);
	...
	public void testDouble3() {
		for (int i = 0; i < 10000; i++) {
			double dl = valid.getDouble(-100, 100);
	...
	public void testValue() {
		...
		for (int i = 0; i < 10000; i++) {
			assertTrue(list.contains(valid.getValue(list)));
		}
	}
